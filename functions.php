...
return'https://blog.ouxiaopi.com/'; //在此输入你需要链接到的URL地址
}
...
function feed_copyright($content) {if(is_single() or is_feed()) {$content.= "<blockquote>";$content.= '<div> 　» 转载请注明来源：<strong><a href="http://blog.ouxiaopi.com" title="小屁君的吐槽" target="_blank">小屁君的吐槽</a> » <a href="'.get_permalink().'" title="'.get_the_title().'" target="_blank" rel="bookmark">《'.get_the_title().'》</a></strong></div>
';$content.= '<div>　» 本文链接地址：<a href="'.get_permalink().'" title="'.get_the_title().'" target="_blank" rel="bookmark"><strong>'.get_permalink().'</strong></a></div>
';$content.= '<div>除非注明，否则均为 <a href="https://blog.ouxiaopi.com/" target="_blank"><strong>小屁君的吐槽 </strong></a>原创文章，转载请以链接形式标明本文地址，谢谢合作！</div>
  ';$content.= "</blockquote>";}return $content;}add_filter ('the_content', 'feed_copyright');
